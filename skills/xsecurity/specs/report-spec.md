<!-- Audience: the Security Lead assembling a report from workflow findings, which writes XSECURITY-RESULTS.md as the delivery step of the scan job. Load this file only when a scan reaches delivery. -->

# XSECURITY-RESULTS.md — report spec
